...
Source0  : https://files.pythonhosted.org/packages/25/37/63e5eca05f58b7d9d9f0525f389f1938afe0f593e4216679fb8af4a5bc6b/azure-mgmt-imagebuilder-0.4.0.zip
...
%prep
%setup -q -n azure-mgmt-imagebuilder-0.4.0
cd %{_builddir}/azure-mgmt-imagebuilder-0.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046441
